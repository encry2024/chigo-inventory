...
@section('content')
{{ Form::open(['route' => 'admin.inventory.item.aircon.check_out.post', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post']) }}
   <div class="box box-success">
      ...
      <div class="box-body">
         <div class="form-group">
            ...
            <div class="col-lg-10">
               {{ Form::text('serial_number', null, ['class' => 'form-control', 'required' => 'required', 'autofocus' => 'autofocus', 'placeholder' => trans('validation.attributes.backend.inventory.aircons.china_serial_number')]) }}
            </div><!--col-lg-10-->
         </div><!--form control-->
      ...
      <div class="box box-info">
         <div class="box-body">
            ...
            <div class="pull-right">
               <button class="btn btn-success btn-xs" type="submit">Check-out</button>
            </div><!--pull-right-->
