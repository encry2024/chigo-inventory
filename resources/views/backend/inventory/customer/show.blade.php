...
@section ('title', trans('labels.backend.inventory.customer.management') . ' | ' . trans('labels.backend.inventory.customer.view'))

@section('page-header')
<h1>
   {{ trans('labels.backend.inventory.customer.management') }}
   <small>{{ trans('labels.backend.inventory.customer.view', ['customer' => $customer->name]) }}</small>
</h1>
@endsection
...
<div class="box box-success">
   <div class="box-header with-border">
      <h3 class="box-title">{{ trans('labels.backend.inventory.customer.view', ['customer' => $customer->name]) }}</h3>
      ...
      <div role="tabpanel">
         ...
         <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane mt-30 active" id="overview">
               @include('backend.inventory.customer.show.tabs.overview')
            </div><!--tab overview profile-->

            <div role="tabpanel" class="tab-pane mt-30" id="history">
               @include('backend.inventory.customer.show.tabs.history')
